...
const RecruiterLogin = () => {
    ...
    const { login } = useContext(AppContext); // Import login function from context
    ...
    return (
        <div className='absolute top-0 bottom-0 left-0 right-0 z-10 flex items-center justify-center backdrop-blur-sm bg-black/30'>
            <form onSubmit={onSubmitHandler} className='relative top-0 p-10 bg-white rounded-xl text-slate-500'>
