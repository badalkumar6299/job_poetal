...
const Hero = () => {
    ...
    return (
        <div className='container mx-auto my-10 2cl:px-20'>
            <div className='py-16 mx-2 text-center text-white bg-[#c6d429] rounded-xl'>
                <h2 className='mb-4 text-2xl font-medium md:text-3xl lg:text-4xl'>Over 1000+ jobs to apply</h2>
                <p className="flex justify-center max-w-xl px-5 mx-auto mb-8 text-sm font-medium text-center text-white">
